...
3. Run the Product Vision workflow before the first PRD
...
Discovery and design exploration may happen before the Foundation Gate, but the first Requirements PRD cannot start until `docs/product/constitution.md` is approved and approved, versioned `docs/product/vision.md` exists.
